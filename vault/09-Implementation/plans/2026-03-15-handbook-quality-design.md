...
| 3 | 왜 중요한가 / Why It Matters | 왜 알아야 하는지. 실생활/업무 연관성. | 4~5개 |
| 4 | 실제로 어디서 쓰이나 / Where It's Used | 제품, 서비스, 일상에서의 사용 사례. 현장 말투로 작성. | 4~5개 |
| 5 | 주의할 점 / Precautions | 흔한 오해, 함정, 잘못된 상식 (쉬운 언어) | 3~4개 |
| 6 | 대화에서는 이렇게 / Communication | 실제 대화/기사에서 이 용어가 등장하는 예시 문장 | 4~5개 |
| 7 | 함께 알면 좋은 용어 / Related Terms | 관련 핸드북 용어 + 한 줄 설명 | 4~6개 |

### Advanced 섹션 (8개)

| # | 섹션 (KO / EN) | 설명 | 수량 |
|---|---------------|------|------|
| 1 | 기술적 설명 / Technical Description | 기술적 정의 + 핵심 구성요소/흐름/수식 | — |
| 2 | 동작 원리 / How It Works | 내부 아키텍처, 알고리즘, 메커니즘 상세 | — |
| 3 | 코드 예시 / Code Example | 실제 코드 스니펫 또는 구현 패턴 (Python/JS 우선) | — |
| 4 | 실무 활용 & 주의점 / Practical Use & Precautions | 실무 사용 사례 + 오용 시 문제점/성능 이슈/보안 취약점 | 4~5 + 4~5 |
| 5 | 왜 중요한가 / Why It Matters | 기술/조직/비즈니스에 미치는 영향 | 4~5개 |
| 6 | 업계 대화 맥락 / Communication | PM·엔지니어 간 회의/문서에서 자주 등장하는 문장. 핵심 용어 굵게 표시. | 6~8개 |
| 7 | 참조 링크 / Reference Links | 공식 문서, 표준, 논문, 기술 블로그, GitHub | — |
| 8 | 관련 기술 & 비교 / Related & Comparison | 유사/경쟁 기술 차이점 + 관련 핸드북 용어 링크 | 4~6개 |
...
| `body_basic_ko/en` | 2,000자 | 7개 섹션을 충실히 작성하면 자연스럽게 충족 |
| `body_advanced_ko/en` | 3,000자 | 코드 예시 포함 시 자연스럽게 충족 |

### 구조 검증

- [ ] Basic의 7개 섹션이 모두 H2(`##`)로 구분되어 있는가
- [ ] Advanced의 8개 섹션이 모두 H2(`##`)로 구분되어 있는가

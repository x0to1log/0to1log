...
AI 파이프라인은 22일 동안 5번의 재설계를 거쳤다. v1은 5일 만에 실패했다 — 아키텍처가 잘못되었고, 패치로는 해결할 수 없었다. $25의 LLM 비용을 태우고 결과물은 0. 전체를 삭제하고 다시 만들자 v2는 1일, v3는 반나절 만에 완성되었다. 6회의 프롬프트 반복으로 품질 점수는 56점에서 90점으로 올랐다.

| | v1 | v2 | v3 | v4 | v5–v6 |
|---|---|---|---|---|---|
| **소요** | 5일 (실패) | 1일 | 반나절 | 반나절 | 9일 |
| **일일 비용** | 동작 안 함 | $0.43 | $0.59 | $0.39 | $0.50–0.80 |
| **결과물** | 없음 | 뉴스 2건 | 뉴스 6–10건 | 6–10건 (2 페르소나) | + 품질 스코어링 |

...
AI 파이프라인은 33일 동안 10번의 버전을 거쳤고, gpt-4o에서 gpt-5까지 모델을 전환했다. v1은 5일간 세 가지 아키텍처 결함을 체계적으로 발견했고, 그 결과 v2는 1일, v3는 반나절 만에 완성되었다. 아래 모든 수치는 프로덕션 DB에서 측정한 실측 데이터이다.

| 지표 (실측) | v2-v4 | v5-v8 | v9 | v10 (gpt-5) |
|---|---|---|---|---|
| **평균 비용/run** | $0.18 | $0.20-$0.25 | $0.43 | $0.58 |
| **모델** | gpt-4o | gpt-4.1 | gpt-4.1 | gpt-5 |
| **Expert citation** | 1.8-2.7 | 12.9-16.8 | 17.5-20.5 | 17.5-20.5 |
| **품질 (R/B)** | 76/83 | 92/95 | 94/95 | 96/91 |

근본 원인 발견, 핵심 의사결정, gpt-5 마이그레이션, 정량적 결과를 포함한 전체 기록은 [개발 여정](./docs/portfolio/pipeline-journey.ko.md)에 있다.

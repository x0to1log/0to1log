...
AI 파이프라인은 26일 동안 9번의 버전을 거쳤다. v1은 5일간 세 가지 아키텍처 결함을 체계적으로 발견했고, 그 결과 v2는 1일, v3는 반나절 만에 완성되었다. 단일 소스 요약에서 다중 소스 종합으로 진화했다. 아래 모든 수치는 프로덕션 DB에서 측정한 실측 데이터이다.

| 지표 (실측) | v2–v4 | v5–v6 | v7–v8 | v9 |
|---|---|---|---|---|
| **평균 비용/run** | $0.18 | $0.20 | $0.25 | $0.55 |
| **Expert citation** | 1.8–2.7 | 12.9–13.9 | 14.2–16.8 | 16.8 |
| **기사당 참조 소스** | 1 | 1 | 1 | 최대 5 |
| **수집 소스** | 1 | 4 | 6 | 6 |

근본 원인 발견, 핵심 의사결정, 비용 트레이드오프, 정량적 결과를 포함한 전체 기록은 [개발 여정](./docs/portfolio/pipeline-journey.ko.md)에 있다.
